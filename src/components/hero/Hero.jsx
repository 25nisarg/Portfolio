  ...
  return (
    <div className='hero'>
      ...
      <div className="hSection right">
        ...
        <Speech />
        {/* {Certificate} */}
        {/* <motion.div animate={{ opacity: [0, 1] }} transition={{ duration: 2 }} className="certificate">
        ...
        {/* {Contact Button} */}
        <motion.a href="#contact" className='contactLink' animate={{ x: [200, 0] }} transition={{ duration: 2 }}>
